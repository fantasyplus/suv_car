...
if(xavier_upstart_CONFIG_INCLUDED)
  return()
endif()
set(xavier_upstart_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(xavier_upstart_SOURCE_PREFIX /home/ros/suv_car/src/xavier_upstart)
  set(xavier_upstart_DEVEL_PREFIX /home/ros/suv_car/devel)
  set(xavier_upstart_INSTALL_PREFIX "")
  set(xavier_upstart_PREFIX ${xavier_upstart_DEVEL_PREFIX})
else()
  set(xavier_upstart_SOURCE_PREFIX "")
  set(xavier_upstart_DEVEL_PREFIX "")
  set(xavier_upstart_INSTALL_PREFIX /home/ros/suv_car/install)
  set(xavier_upstart_PREFIX ${xavier_upstart_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'xavier_upstart' is deprecated")
...
set(xavier_upstart_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(xavier_upstart_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'liu.hua.feng <liu.hua.fengQ@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${xavier_upstart_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'xavier_upstart' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'xavier_upstart' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/suv_car/src/xavier_upstart/${idir}'.  ${_report}")
    endif()
    _list_append_unique(xavier_upstart_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND xavier_upstart_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND xavier_upstart_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT xavier_upstart_NUM_DUMMY_TARGETS)
      set(xavier_upstart_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::xavier_upstart::wrapped-linker-option${xavier_upstart_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR xavier_upstart_NUM_DUMMY_TARGETS "${xavier_upstart_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::xavier_upstart::wrapped-linker-option${xavier_upstart_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND xavier_upstart_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(xavier_upstart_LIBRARY_DIRS ${lib_path})
      list(APPEND xavier_upstart_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'xavier_upstart'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND xavier_upstart_LIBRARIES ${lib})
    endif()
  endif()
...
set(xavier_upstart_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${xavier_upstart_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 xavier_upstart_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${xavier_upstart_dep}_FOUND)
      find_package(${xavier_upstart_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${xavier_upstart_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(xavier_upstart_INCLUDE_DIRS ${${xavier_upstart_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(xavier_upstart_LIBRARIES ${xavier_upstart_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${xavier_upstart_dep}_LIBRARIES})
  _list_append_deduplicate(xavier_upstart_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(xavier_upstart_LIBRARIES ${xavier_upstart_LIBRARIES})

  _list_append_unique(xavier_upstart_LIBRARY_DIRS ${${xavier_upstart_dep}_LIBRARY_DIRS})
  list(APPEND xavier_upstart_EXPORTED_TARGETS ${${xavier_upstart_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${xavier_upstart_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
