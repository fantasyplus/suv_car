...
if(ray_ground_filter_CONFIG_INCLUDED)
  return()
endif()
set(ray_ground_filter_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ray_ground_filter_SOURCE_PREFIX /home/ros/suv_car/src/ros_rslidar/rslidar_ws/ray_ground_filter)
  set(ray_ground_filter_DEVEL_PREFIX /home/ros/suv_car/devel)
  set(ray_ground_filter_INSTALL_PREFIX "")
  set(ray_ground_filter_PREFIX ${ray_ground_filter_DEVEL_PREFIX})
else()
  set(ray_ground_filter_SOURCE_PREFIX "")
  set(ray_ground_filter_DEVEL_PREFIX "")
  set(ray_ground_filter_INSTALL_PREFIX /home/ros/suv_car/install)
  set(ray_ground_filter_PREFIX ${ray_ground_filter_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ray_ground_filter' is deprecated")
...
set(ray_ground_filter_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(ray_ground_filter_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${ray_ground_filter_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ray_ground_filter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ray_ground_filter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/suv_car/src/ros_rslidar/rslidar_ws/ray_ground_filter/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ray_ground_filter_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND ray_ground_filter_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND ray_ground_filter_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT ray_ground_filter_NUM_DUMMY_TARGETS)
      set(ray_ground_filter_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ray_ground_filter::wrapped-linker-option${ray_ground_filter_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ray_ground_filter_NUM_DUMMY_TARGETS "${ray_ground_filter_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ray_ground_filter::wrapped-linker-option${ray_ground_filter_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ray_ground_filter_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(ray_ground_filter_LIBRARY_DIRS ${lib_path})
      list(APPEND ray_ground_filter_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ray_ground_filter'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ray_ground_filter_LIBRARIES ${lib})
    endif()
  endif()
...
set(ray_ground_filter_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ray_ground_filter_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "nodelet;pcl_ros;pluginlib;roscpp;sensor_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 ray_ground_filter_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ray_ground_filter_dep}_FOUND)
      find_package(${ray_ground_filter_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ray_ground_filter_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ray_ground_filter_INCLUDE_DIRS ${${ray_ground_filter_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ray_ground_filter_LIBRARIES ${ray_ground_filter_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ray_ground_filter_dep}_LIBRARIES})
  _list_append_deduplicate(ray_ground_filter_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ray_ground_filter_LIBRARIES ${ray_ground_filter_LIBRARIES})

  _list_append_unique(ray_ground_filter_LIBRARY_DIRS ${${ray_ground_filter_dep}_LIBRARY_DIRS})
  list(APPEND ray_ground_filter_EXPORTED_TARGETS ${${ray_ground_filter_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ray_ground_filter_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
