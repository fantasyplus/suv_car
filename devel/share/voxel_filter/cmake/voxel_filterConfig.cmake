...
if(voxel_filter_CONFIG_INCLUDED)
  return()
endif()
set(voxel_filter_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(voxel_filter_SOURCE_PREFIX /home/ros/suv_car/src/ros_rslidar/rslidar_ws/voxel_filter)
  set(voxel_filter_DEVEL_PREFIX /home/ros/suv_car/devel)
  set(voxel_filter_INSTALL_PREFIX "")
  set(voxel_filter_PREFIX ${voxel_filter_DEVEL_PREFIX})
else()
  set(voxel_filter_SOURCE_PREFIX "")
  set(voxel_filter_DEVEL_PREFIX "")
  set(voxel_filter_INSTALL_PREFIX /home/ros/suv_car/install)
  set(voxel_filter_PREFIX ${voxel_filter_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'voxel_filter' is deprecated")
...
set(voxel_filter_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(voxel_filter_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${voxel_filter_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'voxel_filter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'voxel_filter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/suv_car/src/ros_rslidar/rslidar_ws/voxel_filter/${idir}'.  ${_report}")
    endif()
    _list_append_unique(voxel_filter_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND voxel_filter_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND voxel_filter_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT voxel_filter_NUM_DUMMY_TARGETS)
      set(voxel_filter_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::voxel_filter::wrapped-linker-option${voxel_filter_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR voxel_filter_NUM_DUMMY_TARGETS "${voxel_filter_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::voxel_filter::wrapped-linker-option${voxel_filter_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND voxel_filter_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(voxel_filter_LIBRARY_DIRS ${lib_path})
      list(APPEND voxel_filter_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'voxel_filter'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND voxel_filter_LIBRARIES ${lib})
    endif()
  endif()
...
set(voxel_filter_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${voxel_filter_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 voxel_filter_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${voxel_filter_dep}_FOUND)
      find_package(${voxel_filter_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${voxel_filter_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(voxel_filter_INCLUDE_DIRS ${${voxel_filter_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(voxel_filter_LIBRARIES ${voxel_filter_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${voxel_filter_dep}_LIBRARIES})
  _list_append_deduplicate(voxel_filter_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(voxel_filter_LIBRARIES ${voxel_filter_LIBRARIES})

  _list_append_unique(voxel_filter_LIBRARY_DIRS ${${voxel_filter_dep}_LIBRARY_DIRS})
  list(APPEND voxel_filter_EXPORTED_TARGETS ${${voxel_filter_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${voxel_filter_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
