...
if(nmea_driver_CONFIG_INCLUDED)
  return()
endif()
set(nmea_driver_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(nmea_driver_SOURCE_PREFIX /home/ros/suv_car/src/nmea_driver)
  set(nmea_driver_DEVEL_PREFIX /home/ros/suv_car/devel)
  set(nmea_driver_INSTALL_PREFIX "")
  set(nmea_driver_PREFIX ${nmea_driver_DEVEL_PREFIX})
else()
  set(nmea_driver_SOURCE_PREFIX "")
  set(nmea_driver_DEVEL_PREFIX "")
  set(nmea_driver_INSTALL_PREFIX /home/ros/suv_car/install)
  set(nmea_driver_PREFIX ${nmea_driver_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'nmea_driver' is deprecated")
...
set(nmea_driver_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(nmea_driver_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'liu.hua.feng <liu.hua.feng@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${nmea_driver_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'nmea_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'nmea_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/suv_car/src/nmea_driver/${idir}'.  ${_report}")
    endif()
    _list_append_unique(nmea_driver_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND nmea_driver_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND nmea_driver_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT nmea_driver_NUM_DUMMY_TARGETS)
      set(nmea_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::nmea_driver::wrapped-linker-option${nmea_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR nmea_driver_NUM_DUMMY_TARGETS "${nmea_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::nmea_driver::wrapped-linker-option${nmea_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND nmea_driver_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(nmea_driver_LIBRARY_DIRS ${lib_path})
      list(APPEND nmea_driver_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'nmea_driver'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND nmea_driver_LIBRARIES ${lib})
    endif()
  endif()
...
set(nmea_driver_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${nmea_driver_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 nmea_driver_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${nmea_driver_dep}_FOUND)
      find_package(${nmea_driver_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${nmea_driver_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(nmea_driver_INCLUDE_DIRS ${${nmea_driver_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(nmea_driver_LIBRARIES ${nmea_driver_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${nmea_driver_dep}_LIBRARIES})
  _list_append_deduplicate(nmea_driver_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(nmea_driver_LIBRARIES ${nmea_driver_LIBRARIES})

  _list_append_unique(nmea_driver_LIBRARY_DIRS ${${nmea_driver_dep}_LIBRARY_DIRS})
  list(APPEND nmea_driver_EXPORTED_TARGETS ${${nmea_driver_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${nmea_driver_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
