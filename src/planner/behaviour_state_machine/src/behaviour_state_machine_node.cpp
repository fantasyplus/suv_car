...
{
    // theta_ratio=0.9 940ms opennode:9303
    // normal 1184ms opennode:7491
    // geometry_msgs::PoseWithCovarianceStamped temp_start;
    // temp_start.header.stamp = ros::Time::now();
    // temp_start.header.frame_id = "map";
    // temp_start.pose.pose.position.x = 59.9510192871;
    // temp_start.pose.pose.position.y = 3.91825294495;
    // temp_start.pose.pose.position.z = 0.0;
    // temp_start.pose.pose.orientation.x = 0.0;
    // temp_start.pose.pose.orientation.y = 0.0;
    // temp_start.pose.pose.orientation.z = 0.999932431744;
    // temp_start.pose.pose.orientation.w = 0.0116246267521;
    ...
    // _goal_pose_stamped.pose.position.x = 29.4771823883;
    // _goal_pose_stamped.pose.position.y = 40.1475219727;
    // _goal_pose_stamped.pose.position.z = 0.0;
    // _goal_pose_stamped.pose.orientation.x = 0.0;
    // _goal_pose_stamped.pose.orientation.y = 0.0;
    // _goal_pose_stamped.pose.orientation.z = 0.999932424815;
    // _goal_pose_stamped.pose.orientation.w = -0.0116252227582;
